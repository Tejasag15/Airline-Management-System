...
<html>
	...
	<body>
		...
		<?php
			...
			$query="SELECT pnr,date_of_reservation,flight_no,journey_date,class,booking_status,no_of_passengers,payment_id FROM Ticket_Details  ORDER BY  journey_date";
			$stmt=mysqli_prepare($dbc,$query);
